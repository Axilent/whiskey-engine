...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('whiskeyengine_whiskey', 'thumb', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Whiskey.thumb'
        db.delete_column('whiskeyengine_whiskey', 'thumb')
